        ...
        <Card className="border-border/50 bg-card/50 backdrop-blur-sm">
          <CardContent className="p-0 relative">
            <div className="overflow-auto max-h-[70vh]">
              <Table>
                <TableHeader className="sticky top-0 z-10 bg-card/95 backdrop-blur border-b border-border/50 shadow-sm">
                  <TableRow className="border-border/50 hover:bg-transparent">
                    <TableHead className="font-semibold text-foreground min-w-[200px] bg-card/95 backdrop-blur">
                      Modell
                    </TableHead>
                    {TEST_FEATURES.map((feature) => (
                      <TableHead key={feature.id} className="text-center min-w-[120px] bg-card/95 backdrop-blur">
